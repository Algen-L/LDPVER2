                                                ...
                                                <div style="display: flex; gap: 12px; align-items: flex-start;">
                                                    <div
                                                        ...
                                                        <?php if (!empty($notif['sender_picture'])): ?>
                                                            <img src="<?php echo PUBLIC_ROOT . htmlspecialchars($notif['sender_picture']); ?>"
                                                                style="width: 100%; height: 100%; object-fit: cover;">
                                                        <?php else: ?>
                                                            <div
                                                                style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: var(--primary); color: white; font-weight: 800; font-size: 1rem;">
