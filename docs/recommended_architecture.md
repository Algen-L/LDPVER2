...
What the public folder does is that it is the only folder that is accessible to the outside world. The other folders are not accessible to the outside world. This is a security measure to prevent hackers from accessing your sensitive files. http://localhost/LDPVer2/public/index.php
